...
echo "  bash run_collect_specimens.sh --contact-email \"your.email@example.com\" --taxon \"Haplopteris mediosora\" --synonym \"Vittaria mediosora\" --image-resolution low --output output/Haplopteris_mediosora_low"
